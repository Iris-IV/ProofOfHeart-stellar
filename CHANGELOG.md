...
- `update_campaign_description` now blocks edits after verification (`require_unverified_campaign`), consistent with `update_campaign`, preventing bait-and-switch after admin or community approval (#440).
